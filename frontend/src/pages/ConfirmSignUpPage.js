...
const ConfirmSignUpPage = () => {
  ...
  return (
    <div className={"space-x-2"}>
      ...
      <input className={"h-10 rounded-md border-2 border-white hover:border-purple-40"} type="text" value={email} onChange={(e) => setUsername(e.target.value)} placeholder="Username"/>
